...
import com.example.popular_libraries.baselogic.user.RepositoryListPresenter
import com.example.popular_libraries.databinding.RepositoryItemViewBinding
...
class RepositoryRVAdapter(private val presenterRepository: RepositoryListPresenter) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(
            RepositoryItemViewBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false))
            .apply {
